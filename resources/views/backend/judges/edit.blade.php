            ...
            <div class="row">
                <div class="col">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                      <label for="judge_current_judge_level" class="form-label">Jugde Current Court Level</label>
                      <select id="judge_current_judge_level" class="form-select" name="judge_current_judge_level" style="width: 100%;">
                ...
                <div class="col">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                      <label for="judge_previous_judge_level" class="form-label">Jugde Previous Court Level</label>
                      <select id="judge_previous_judge_level" class="form-select" name="judge_previous_judge_level" style="width: 100%;">
                        <option value="Supreme Court">Supreme Court</option>
                        <option value="Court of Appeal">Court of Appeal</option>
                        <option value="High Court">High Court</option>
                        <option value="Employment and Labor Relations Court">Employment and Labor Relations Court</option>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#judge_current_judge_level').select2()
    })
    $(document).ready(function () {
    ...
    $(document).ready(function () {
        $('#judge_previous_judge_level').select2()
    })
    $(document).ready(function () {
