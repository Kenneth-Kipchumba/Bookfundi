  ...
  <div class="container-fluid">
    <div class="card">
        <div class="card-header">
           <h3>Advocates Table</h3>
           <a href="{{ route('backend.advocates.create') }}" class="btn btn-primary right">Create new advocate</a>
        </div>
        <div class="card-body">
           <div class="table-responsive">
              <table class="table table-bordered border-primary table-hover table-sm">
               ...
               <tbody>
                ...
                <tr>
                   <td>
                       <a href="{{ route('backend.advocates.show', $advocate->id) }}">
                   ...
                   <td>
                       <a href="{{ route('backend.advocates.edit', $advocate->id) }}" class="btn btn-sm btn-primary float-left">
                           <i class="fas fa-pen"></i>
                       </a>
                       <?php
                       

                       $slug = Str::slug($advocate->advocate_name);
                       ?>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content bg-danger">
                              ...
                              <div class="modal-footer">
                                ...
                                <form action="{{ route('backend.advocates.destroy', $advocate->id) }}" method="POST">
                                  @csrf
                                  @method('DELETE')
