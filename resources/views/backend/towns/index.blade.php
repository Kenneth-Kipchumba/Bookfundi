  ...
  <div class="container-fluid">
    <div class="card">
        <div class="card-header">
           <h3>Towns Table</h3>
           <a href="{{ route('backend.towns.create') }}" class="btn btn-primary right">Create new town</a>
        </div>
        <div class="card-body">
              ...
              <table class="table table-bordered border-primary table-hover table-sm">
               <thead>
                   <tr>
                       <th>Town Name</th>
                       <th>Town Country</th>
                       <th>Town County/State/Province</th>
                       <th>Action</th>
                   </tr>
               </thead>
               <tbody>
                ...
                <tr>
                   <td>
                       <a href="{{ route('backend.towns.show', $town->id) }}">
                           {{ $town->town_name }}
                       </a>
                   </td>
                            ...
                            <div class="modal-content bg-danger">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">
                                    You are about to remove {{ $town->town_name }} from the system. Are you sure you want to proceed.
                                </h5>
                              ...
                              <div class="modal-footer">
                                ...
                                <form action="{{ route('backend.towns.destroy', $town->id) }}" method="POST">
                                  @csrf
                                  @method('DELETE')
