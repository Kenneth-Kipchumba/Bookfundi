  ...
  <div class="container-fluid">
    <div class="card">
        <div class="card-header">
           <h3>Create a new Firm</h3>
        </div>
        <div class="card-body">
           <form action="{{ route('backend.firms.store') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col">
                    <div class="card card-info">
                      ...
                      <input type="text" name="firm_name" class="form-control @error('firm_name') is-invalid @enderror" id="firm_name">
                      @error('firm_name')
                        <p class="text-danger">
                            {{ $message }}
                        </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="mb-3">
                              ...
                              <input type="text" name="firm_address" class="form-control @error('firm_address') is-invalid @enderror" id="firm_address">
                                @error('firm_address')
                                  <p class="text-danger">
                                      {{ $message }}
                                  </p>
